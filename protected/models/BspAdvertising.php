...
class BspAdvertising extends DTActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('adv_img, adv_url, iStatus, adv_name_de, adv_img_de, adv_url_de, create_time, create_user_id, update_time, update_user_id', 'required'),
	...
	public function attributeLabels()
	{
		return array(
			...
			'adv_img' => 'Adv Img',
			'adv_url' => 'Adv Url',
			'adv_position' => 'Adv Position',
			'iStatus' => 'I Status',
			'adv_name_de' => 'Adv Name De',
			'adv_img_de' => 'Adv Img De',
			'adv_url_de' => 'Adv Url De',
