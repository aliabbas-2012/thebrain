...
class BspCategory extends DTActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			...
			'parent_id' => 'each category must have their parent, the parent has id = 0, and the child  category has parent_id',
			'level' => 'the index of category',
			'num_post' => 'when user post new item in the selected category, this field auto increase +1, when loading this page we do not take time to re-calculate',
