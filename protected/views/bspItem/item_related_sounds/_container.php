                ...
                <table class="table table-bordered table-condensed table-hover table-striped dataTable">
                    <thead>
                        <tr class="odd grid_title">
                            <td class=" sorting_1"> <div class="title"><?php echo CHtml::activeLabel($relateModelobj, 'name'); ?></div></td>
                            <td class=" sorting_1"> <div class="title"><?php echo CHtml::activeLabel($relateModelobj, 'url'); ?></div></td>
