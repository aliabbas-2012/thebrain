...
$(document).ready(function() {
    ...
    if (divElement.hasClass('pieStats')) {
        $(function() {
            var data = [
                {label: "%78.75 Fix Price", data: 78.75, color: "#88bbc8"},
                {label: "%21.25 Price per hour", data: 21.25, color: "#ed7a53"},
                {label: "%21.25 Price per day", data: 21.25, color: "#ed7a53"},
                {label: "%21.25 Price per week", data: 21.25, color: "#ed7a53"},
                {label: "%21.25 Price per month", data: 21.25, color: "#ed7a53"}
            ];
            
            var test_data = [
                {data:40,label:"Fix Price",color:"#F0F8FF"},
                {data:40,label:"Price per hour",color:"#FAEBD7"},
                {data:8,label:"Price per day",color:"#00FFFF"},
                {data:4,label:"Price per week",color:"#8A2BE2"},
                {data:0,label:"Price per month",color:"#D2691E"},
                {data:8,label:"None",color:"#006400"}
            ];
